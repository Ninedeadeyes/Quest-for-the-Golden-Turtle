...
wn= turtle.Screen()
wn.bgcolor("black")
wn.title("Pac Man vs The Goblins of Doom")
wn.setup(800,800)
wn.tracer(0)


images=[".\\art\\wall.gif",".\\art\\orkleft.gif",".\\art\\ork.gif",".\\art\\orkup.gif",".\\art\\gold.gif",".\\art\\fire.gif",".\\art\\door.gif",".\\art\\orkright.gif",".\\art\\miss_pacman.gif",
        ".\\art\\pacman_right_1.gif",".\\art\\pacman_right_2.gif",".\\art\\pacman_left_1.gif",".\\art\\pacman_left_2.gif",".\\art\\pacman_up_1.gif",".\\art\\pacman_up_2.gif",".\\art\\pacman_down_1.gif",".\\art\\pacman_down_2.gif"]
...
class Info():
    ...
    def win(self):
        msg= (""" 
   You have rescued Miss Pac-Man  !! You win !!
                      Click (x) to exit
...
class Crown(turtle.Turtle):
    def __init__(self,x,y):
        turtle.Turtle.__init__(self)
        self.shape(".\\art\\miss_pacman.gif")
        self.color("gold")
        self.penup()
        self.speed(0)
        self.gold= 100
...
class Player(turtle.Turtle):
    def __init__(self):
        turtle.Turtle.__init__(self)
        self.shape(".\\art\\pacman_right_1.gif")
        self.penup()
        self.speed()
        self.fd(0)
        self.right=1
    ...
    def go_up(self):
        ...
        if self.frame==0:
            self.shape(".\\art\\pacman_up_1.gif")
            self.frame=1
        else:
    ...
    def go_down(self):
        ...
        if self.frame==0:
            self.shape(".\\art\\pacman_down_1.gif")
            self.frame=1
        else:
    ...
    def go_left(self):
        ...
        move_to_y = self.ycor()
        if self.frame==0:
            self.shape(".\\art\\pacman_left_1.gif")
            self.frame=1
        else:
